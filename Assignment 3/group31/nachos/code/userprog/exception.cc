...
extern void executionbegins(char*);
...
ExceptionHandler(ExceptionType which)
{
    ...
    int exitcode,shmsize,pagesCreated;		// Used in SYScall_Exit
    unsigned i;
	...
	DEBUG('a', "Shutdown, initiated by user program.\n");
       ...
       shmsize = machine->ReadRegister(4);
       
       // create a new Page table with shared pages
       sharedMemoryStart = (unsigned)currentThread->space->makesharedtable(shmsize, &pagesCreated);
